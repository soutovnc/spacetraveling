...
export default function Post({
  ...
  const readingTime = Math.ceil((amountWordsOfBody + amountWordsOfBody) / 200);
      ...
      <main className={commonStyles.content}>
        <article className={styles.post}>
          ...
          <div className={styles.postInfo}>
            <span>
              <FiCalendar size={20} color="#BBBBB" />
            ...
            <div className={styles.posContent}>
              {post.data.content.map(({ heading, body }) => (
                <div key={heading}>
                  ...
                  <div
                    className={styles.postSelection}
...
export const getStaticProps: GetStaticProps<PostProps> = async ({
  ...
  const responseNextPost = await prismic.query(
    Prismic.Predicates.at('document.type', 'post'),
    { pageSize: 1, after: slug, orderings: '[document.first_publiction_date]' }
  );
